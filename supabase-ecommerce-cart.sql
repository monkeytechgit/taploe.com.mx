...
values
  ...
  ('google_reviews', 'mx', 'es-MX', 'Tarjeta NFC para reseñas de Google', 'Tarjeta NFC y QR para recibir reseñas de Google.', 'review_card', 'PVC', true, 'prod_V7vTSs02zTQ82G', 'price_1U7oXJE9Iq6fzuQIhYOg86xl', '/assets/images/producto-resenas-google.webp', '{"ecommerce": true}'::jsonb),
...
from (
  values
    ...
    ('mx', 'google_reviews', 'sencilla', 'Sencilla', 'price_1U7oXJE9Iq6fzuQIhYOg86xl', 'MXN', 10::numeric, 10::numeric, 1, true, true, '{}'::jsonb),
