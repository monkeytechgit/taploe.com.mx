...
values
  ...
  ('nfc_metalica', 'mx', 'es-MX', 'Tarjeta de presentación NFC metálica', 'Tarjeta de presentación NFC metálica premium con perfil digital incluido.', 'nfc_card', 'Metal', true, true, 'prod_V7vOh1Cf5NKlkk', 'price_1U7oYYE9Iq6fzuQIbWruOCN8', '/assets/images/producto-tarjeta-nfc-metalica.webp', '{"ecommerce": true}'::jsonb),
  ('google_reviews', 'mx', 'es-MX', 'Tarjeta NFC para reseñas de Google', 'Tarjeta NFC y QR para recibir reseñas de Google.', 'review_card', 'PVC', true, true, 'prod_V7vTSs02zTQ82G', 'price_1U7oXJE9Iq6fzuQIhYOg86xl', '/assets/images/producto-resenas-google.webp', '{"ecommerce": true}'::jsonb),
...
from (
  values
    ...
    ('mx', 'nfc_metalica', 'unit', 'Tarjeta de presentación NFC metálica', 'price_1U7oYYE9Iq6fzuQIbWruOCN8', 'MXN', 10::numeric, 10::numeric, 1, true, '{}'::jsonb),
    ('mx', 'google_reviews', 'sencilla', 'Sencilla', 'price_1U7oXJE9Iq6fzuQIhYOg86xl', 'MXN', 10::numeric, 10::numeric, 1, true, '{}'::jsonb),
