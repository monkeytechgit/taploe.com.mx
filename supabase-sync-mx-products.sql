...
values
  ...
  ('google_reviews', 'mx', 'es-MX', 'Tarjeta NFC para reseñas de Google', 'Tarjeta NFC y QR para recibir reseñas de Google.', 'review_card', 'PVC', true, true, 'prod_V7vTSs02zTQ82G', 'price_1U7fc7E9Iq6fzuQIvpAYImou', '/assets/images/producto-google-reviews.webp', '{"ecommerce": true}'::jsonb),
